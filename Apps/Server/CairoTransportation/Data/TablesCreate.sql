...
CREATE TABLE `traffic_period_multipliers` (
...
ALTER TABLE `route_stops`
ADD CONSTRAINT `fk_route_stops_location`
FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE;

ALTER TABLE `transport_demand`
ADD CONSTRAINT `fk_demand_from`
FOREIGN KEY (`from_location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE;

ALTER TABLE `transport_demand`
ADD CONSTRAINT `fk_demand_to`
FOREIGN KEY (`to_location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE;

ALTER TABLE `road_maintenance`
ADD CONSTRAINT `fk_road_maintenance_road`
FOREIGN KEY (`road_id`) REFERENCES `roads` (`id`) ON DELETE CASCADE;