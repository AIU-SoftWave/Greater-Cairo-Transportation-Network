...
('16','New Sheikh Zayed','NEIGHBORHOOD','Residential',180000,30.90,30.03,0),
('17','New Maadi','NEIGHBORHOOD','Residential',210000,31.28,29.90,0),
('18','East Heliopolis','NEIGHBORHOOD','Mixed',175000,31.39,30.08,0),
('19','Cairo Tech Hub','FACILITY','Business',NULL,31.10,30.00,1),
('20','Medical City','FACILITY','Medical',NULL,31.30,29.98,1),
('21','Ring Road North','NEIGHBORHOOD','Transport',90000,31.18,30.14,0),
('22','Ring Road South','NEIGHBORHOOD','Transport',95000,31.19,29.88,0),
('23','Desert Extension','NEIGHBORHOOD','Residential',110000,30.85,30.08,0),
...
('F11','Central Station 2','FACILITY','Transit',NULL,31.20,30.04,1),
('F12','City Hospital','FACILITY','Medical',NULL,31.27,30.00,1);

-- =========================
-- ROADS (EXISTING)
-- =========================
INSERT INTO roads (from_location_id, to_location_id, distance, capacity, condition, is_existing, is_two_way, construction_cost) VALUES
...
INSERT INTO traffic_flow (road_id, period, flow)
SELECT id,'MORNING',3100 FROM roads WHERE from_location_id='1' AND to_location_id='3';

INSERT INTO traffic_flow (road_id, period, flow)
SELECT id,'EVENING',2900 FROM roads WHERE from_location_id='1' AND to_location_id='3';

INSERT INTO traffic_flow (road_id, period, flow)
SELECT id,'MORNING',2400 FROM roads WHERE from_location_id='21' AND to_location_id='3';

INSERT INTO traffic_flow (road_id, period, flow)
SELECT id,'EVENING',2800 FROM roads WHERE from_location_id='19' AND to_location_id='13';

INSERT INTO traffic_flow (road_id, period, flow)
SELECT id,'NIGHT',1200 FROM roads WHERE from_location_id='20' AND to_location_id='11';

INSERT INTO traffic_flow (road_id, period, flow)
SELECT id,'MORNING',1900 FROM roads WHERE from_location_id='16' AND to_location_id='15';
...
('M4','17',1),('M4','1',2),('M4','3',3),('M4','F11',4),('M4','20',5),
('B3','16',1),('B3','15',2),('B3','7',3),('B3','21',4),('B3','3',5),
('B4','19',1),('B4','13',2),('B4','4',3),('B4','F12',4);
