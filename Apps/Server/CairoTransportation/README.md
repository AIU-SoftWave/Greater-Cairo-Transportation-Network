...
4. You can explore the Swagger UI documentation at `http://localhost:5000/swagger`.

### 2. Running the Frontend UI
The frontend requires the backend API to be running to fetch graph and algorithm data.
...
3. Start the development server:
   ...
   npm run dev
   ```
4. Open your browser and navigate to `http://localhost:3000`. You will see the interactive map of Greater Cairo.
