 ...
 *
 * The roadId matches the "FromID-ToID" format used in the CSV
...
public class TrafficPattern {
    ...
    public TrafficPattern(String roadId, int morningPeakVph, int afternoonVph,
    ...
    public int getMorningPeakVph()                 { return morningPeakVph; }
    public void setMorningPeakVph(int v)           { this.morningPeakVph = v; }

    public int getAfternoonVph()                   { return afternoonVph; }
    public void setAfternoonVph(int v)             { this.afternoonVph = v; }

    public int getEveningPeakVph()                 { return eveningPeakVph; }
    public void setEveningPeakVph(int v)           { this.eveningPeakVph = v; }

    public int getNightVph()                       { return nightVph; }
    public void setNightVph(int v)                 { this.nightVph = v; }
}
